...
type InboundService struct {
	...
	muXray  sync.Mutex // только для последовательного доступа к xrayApi
	muByID  sync.Map
}
...
func (s *InboundService) lockInbound(id int) func() {
	muIface, _ := s.muByID.LoadOrStore(id, &sync.Mutex{})
